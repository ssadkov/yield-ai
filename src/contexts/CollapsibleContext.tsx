...
export function CollapsibleProvider({ children }: CollapsibleProviderProps) {
  const [expandedSections, setExpandedSections] = useState<Set<string>>(new Set(['wallet', 'hyperion', 'echelon', 'aries', 'joule', 'tapp', 'meso', 'auro']));
  ...
  const expandAll = () => {
    setExpandedSections(new Set(['wallet', 'hyperion', 'echelon', 'aries', 'joule', 'tapp', 'meso', 'auro']));
  };
