...
/**
 * GET /api/protocols/decibel/fundingRateHistory
 * Proxies to Decibel funding_rate_history API.
 * Doc: GET /api/v1/funding_rate_history?account={address}&limit=&offset=
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${baseUrl}/api/v1/funding_rate_history?${params.toString()}`;
    ...
    console.error('[Decibel] fundingRateHistory error:', error);
    return NextResponse.json(
