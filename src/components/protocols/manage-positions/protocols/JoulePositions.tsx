                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <Badge variant="outline" className="bg-green-500/10 text-green-600 border-green-500/20 text-base font-semibold px-3 py-1">Supply</Badge>
                            </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <Badge variant="outline" className="bg-red-500/10 text-red-500 border-red-500/20 text-base font-semibold px-3 py-1">Borrow</Badge>
                            </div>
                            <div className="text-base text-muted-foreground mt-0.5">${tokenInfo?.usdPrice ? parseFloat(tokenInfo.usdPrice).toFixed(2) : 'N/A'}</div>
                          </div>
                        </div>
